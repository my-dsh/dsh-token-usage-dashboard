...
function compactNumber(value) {
    ...
    if (abs < 1_000_000)
        return formatScale(value / 1_000, 'K');
    if (abs < 1_000_000_000)
        return formatScale(value / 1_000_000, 'M');
 ...
 */
function formatScale(scaled, suffix) {
...
export function formatThroughput(group) {
    if (group.averageThroughput === null)
        return '—';
 ...
 */
export function formatTtft(group) {
    if (group.averageTtftMs === null)
        return '—';
 ...
 */
export function formatTtftSeconds(averageTtftMs) {
    if (averageTtftMs === null)
        return '—';
 ...
 */
export function formatCacheHit(group) {
    if (group.cacheHitRatio === null)
        return '—';
 ...
 */
export function daysAgoLocalKey(days) {
    const now = new Date();
 ...
 */
export function yesterdayLocalKey() {
 ...
 */
export function startOfMonthLocalKey() {
    const now = new Date();
    const year = now.getFullYear();
    const month = String(now.getMonth() + 1).padStart(2, '0');
 ...
 */
export function startOfLastMonthLocalKey() {
    const now = new Date();
 ...
 */
export function endOfLastMonthLocalKey() {
    const now = new Date();
    const month = now.getMonth();
    const year = month === 0 ? now.getFullYear() - 1 : now.getFullYear();
    const lastMonth = month === 0 ? 0 : month - 1;
 ...
 */
export function orderedGroups(summary) {
