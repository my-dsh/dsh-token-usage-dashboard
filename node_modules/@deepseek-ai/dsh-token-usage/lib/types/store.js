 ...
 */
export function localDayWindow(timeZone, dateKey) {
 ...
 */
export function openTokenUsageDatabase(path) {
...
function configureDatabase(db) {
    ...
    try {
        ...
        if (began) {
            ...
            catch { /* a failed BEGIN IMMEDIATE leaves no transaction to roll back */ }
        }
        throw error;
    }
}
 ...
 */
export class SqliteTokenUsageStore extends Service {
    db;
    /**
